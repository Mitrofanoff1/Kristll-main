...
export default function Hero({ onOpenModal }: { onOpenModal: () => void }) {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-8 pb-12 lg:pt-20 lg:pb-32">
      {/* Фон - понизили z-index до минимума */}
      <Sparkles className="absolute top-6 right-6 text-accent/40 w-6 h-6 lg:w-12 lg:h-12 -z-20 animate-pulse" />
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-72 h-72 bg-accent/20 rounded-full blur-[80px] -z-20"></div>
      <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-72 h-72 bg-accent/10 rounded-full blur-[80px] -z-20"></div>
          ...
          <div className="w-full lg:w-3/5 flex flex-col text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-8 relative z-[101]">
              ...
              <a 
                ...
                className="w-full sm:w-64 bg-white border-2 border-gray-100 text-center text-gray-800 font-extrabold py-4 rounded-full transition-all active:scale-95 uppercase tracking-wider text-base cursor-pointer"
              >
                Выбрать услугу
              </a>
            </div>
            ...
            <div className="flex flex-col gap-4 text-left max-w-2xl mx-auto lg:mx-0 border-t border-gray-50 pt-6">
              <div className="flex items-start gap-3 text-gray-600">
                <div className="bg-accent/20 p-2 rounded-lg mt-0.5"><CheckCircle2 className="text-accent w-4 h-4" /></div>
                <p className="text-[14px] md:text-base leading-tight font-bold">Гладкая кожа без раздражений, порезов и вросших волос</p>
              </div>
              <div className="flex items-start gap-3 text-gray-600">
                <div className="bg-accent/20 p-2 rounded-lg mt-0.5"><Eye className="text-accent w-4 h-4" /></div>
                <p className="text-[14px] md:text-base leading-tight font-bold">Массаж для глаз от Yamaguchi во время сеанса</p>
              </div>
              <div className="flex items-start gap-3 text-gray-600">
                <div className="bg-accent/20 p-2 rounded-lg mt-0.5"><Zap className="text-accent w-4 h-4" /></div>
                <p className="text-[14px] md:text-base leading-tight font-bold">Эпиляция диодным лазером с гибридным излучателем Coherent (USA)</p>
              </div>
            </div>
          </div>
