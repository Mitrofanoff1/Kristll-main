...
export const metadata: Metadata = {
  ...
  description: "Комфортная лазерная эпиляция на диодном лазере с охлаждением. Камерная студия без суеты и потока: деликатный подход и внимание к каждой зоне. Про бритву, раздражение и вросшие волосы — можно забыть. Скидка 20% на первый визит.",
  ...
  twitter: {
    ...
    title: "Kristll Studio — лазерная эпиляция в Мурино",
    description: "Комфортная лазерная эпиляция на диодном лазере с охлаждением. Скидка 20% на первый визит.",
  },
};
